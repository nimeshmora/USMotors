...
<head>
    <title>Home - Home Page | Speed Racing - Car Spare Parts Provider</title>
...
<div id="main">
    ...
    <div id="header">
        <div class="row-1">
            ...
            <div class="fright">
                <ul>
                    <li><a href="home.html"><img src="images/icon1-act.gif" alt="" /></a></li>
        ...
        <div class="row-2">
            <div class="left">
                <ul>
                    ...
                    <li><a href="about-us.html"><span>AutoMobiles</span></a></li>
                    <li><a href="articles.html"><span>Spare Parts</span></a></li>
                    <li><a href="contact-us.html"><span>Contact</span></a></li>
                    <li class="last"><a href="sitemap.html"><span>About</span></a></li>
                </ul>
            </div>
        </div>
        <div class="row-3">
            <div class="inside">
                <h2>Auto Mobile &<b>Spare Parts</b></h2>
                <p>We are the best Japan automobile spare parts provider for all over the countries</p>
    ...
    <div id="content">
        ...
        <div class="indent">
            <div class="wrapper">
                <div class="col-1">
                    <h3><b>Welcome to</b> US Motors</h3>
                    <p>Speed Racing Site is a free web template created by TemplateMonster.com team. This website template is optimized for 1024X768 screen resolution. It is also XHTML &amp; CSS valid.</p>
                    ...
                    <p>This website template has several pages: <a href="home.html">Home</a>, <a href="about-us.html">About us</a>, <a href="articles.html">Article</a> (with Article page), <a href="contact-us.html">Contact us</a> (note that contact us form – doesn’t work), <a href="sitemap.html">Site Map</a>.</p>
